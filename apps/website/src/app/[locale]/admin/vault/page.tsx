  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">Alecia Vault</h1>
          <p className="text-muted-foreground">Coffre-fort de mots de passe et gestion sécurisée</p>
        </div>
        <a
          href="https://vault.alecia.markets"
          target="_blank"
