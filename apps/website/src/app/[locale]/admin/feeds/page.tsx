  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">Alecia Veille</h1>
          <p className="text-muted-foreground">Agrégateur de flux RSS et veille sectorielle</p>
        </div>
        <a
          href="https://feeds.alecia.markets"
          target="_blank"
