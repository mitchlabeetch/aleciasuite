  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">Alecia Research</h1>
          <p className="text-muted-foreground">Recherche entreprises et intelligence économique</p>
        </div>
        <a
          href="https://search.alecia.markets"
          target="_blank"
