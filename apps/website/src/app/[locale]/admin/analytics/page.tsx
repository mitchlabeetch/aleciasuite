  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">Alecia Analytics</h1>
          <p className="text-muted-foreground">Analytics web et métriques de performance</p>
        </div>
        <a
          href="https://analytics.alecia.markets"
          target="_blank"
